        ...
        <el-row>
            ...
            <el-card class="box-card">
                ...
                <el-form-item label="描述" prop="descri">
                    <el-input v-model="dataForm1.descri" placeholder=""></el-input>
                </el-form-item>
    ...
    <div>
        <el-row>
            ...
            <el-card class="box-card">
                ...
                <el-form-item label="描述" prop="descri">
                    <el-input v-model="dataForm2.descri" placeholder=""></el-input>
                </el-form-item>
                <el-form-item label="展示顺序" prop="iorder">
    ...
    <div>
        <el-row>
            ...
            <el-card class="box-card">
                ...
                <el-form-item label="描述" prop="descri">
                    <el-input v-model="dataForm3.descri" placeholder=""></el-input>
                </el-form-item>
                <el-form-item label="展示顺序" prop="iorder">
  ...
  export default {
    ...
    methods: {
      ...
      getDataList1 () {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/techimages/en/list'),
          method: 'get',
      ...
      dataFormSubmit1 () {
        this.$refs['dataForm1'].validate((valid) => {
          if (valid && this.bigPicture.length > 0) {
            ...
            this.$http({
              url: this.$http.adornUrl('/generator/techimages/en/save'),
              method: 'post',
              data: goodsObj
            }).then(({data}) => {
              this.$message({
      ...
      deleteHandle (id) {
        ...
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/generator/techimages/en/delete'),
            method: 'post',
            data: imgObj
          }).then(({data}) => {
            this.$message({
