  ...
  export default {
    ...
    methods: {
      savePGName (id, pgName) {
        this.$http({
          url: this.$http.adornUrl(`/generator/paramgroup/en/update`),
          method: 'post',
      ...
      delPG (id) {
        ...
        this.$http({
          url: this.$http.adornUrl(`/generator/paramgroup/en/delete?id=` + id),
          method: 'get'
        }).then(({data}) => {
          if (data && data.code === 0) {
            this.$message({
      ...
      updateShowInGoods (id, isShow) {
        // 传递到后台保存
        this.$http({
          url: this.$http.adornUrl(`/generator/goodsparams/en/update`),
          method: 'post',
          data: this.$http.adornData({
            'id': id,
            'showInGoods': isShow
      ...
      append (data, id) {
        ...
        this.$http({
          url: this.$http.adornUrl(`/generator/goodsparams/en/append`),
          method: 'post',
          data: this.$http.adornData({
            'parentId': data.id,
            'label': '新建分类',
      ...
      remove (node, data) {
        ...
        this.$http({
          url: this.$http.adornUrl(`/generator/goodsparams/en/delete?id=` + data.id),
          method: 'get'
        }).then(({data}) => {
          if (data && data.code === 0) {
            this.$message({
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/goodsparams/en/list'),
          method: 'get'
        }).then(({data}) => {
