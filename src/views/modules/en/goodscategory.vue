  ...
  export default {
    ...
    methods: {
      ...
      append (data) {
        ...
        this.$http({
          url: this.$http.adornUrl(`/generator/goodscategory/en/append`),
          method: 'post',
      ...
      remove (node, data) {
        ...
        this.$http({
          url: this.$http.adornUrl(`/generator/goodscategory/en/delete?id=` + data.id),
          method: 'get'
        }).then(({data}) => {
          if (data && data.code === 0) {
            this.$message({
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/goodscategory/en/list'),
          method: 'get'
        }).then(({data}) => {
          let array = {}
          let returnArray = []
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/generator/goodscategory/en/delete'),
            method: 'post',
