  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/webase/list'), // list英文中文公用一个，下面会筛选
          method: 'get',
          ...
          if (data && data.code === 0) {
            ...
            for (var i = 0; i < this.dataList.length; i++) {
              if (this.dataList[i].paramKey === 'WEBASE_KEY_EN') {
      ...
      delWebBase () {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/webase/delete'), // delete中英文公用一个
          method: 'post',
          data: data
        }).then(({data}) => {
          this.$message({
      ...
      dataFormSubmit () {
        if (this.configId === 0) {
          ...
          this.$http({
            url: this.$http.adornUrl('/generator/webase/en/save'),
            method: 'post',
            data: data
          }).then(({data}) => {
            this.$message({
          ...
          this.$http({
            url: this.$http.adornUrl('/generator/webase/en/update?id=' + this.configId),
            method: 'post',
            data: data
          }).then(({data}) => {
            this.$message({
      ...
      mallDataFormSubmit () {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/webimages/en/save-and-update'),
          method: 'post',
          data: goodsObj
        }).then(({data}) => {
          this.$message({
      ...
      getMallPicture () {
        this.dataListLoading = true
        this.$http({
          url: this.$http.adornUrl('/generator/webimages/en/getMallPicture'),
          method: 'get'
        }).then(({data}) => {
          console.log(data)
          if (data && data.code === 0) {
      ...
      delMall () {
        this.$http({
          url: this.$http.adornUrl('/generator/webimages/en/delMallPicture'),
          method: 'get'
        }).then(({data}) => {
          console.log(data)
          if (data && data.code === 0) {
