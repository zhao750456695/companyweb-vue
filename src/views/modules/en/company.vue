    ...
    methods: {
      ...
      deleteHandle (id) {
        ...
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/generator/webimages/en/delete'),
            method: 'post',
            data: imgObj
          }).then(({data}) => {
            this.$message({
      ...
      pdataFormSubmit () {
        if (this.introPicture.length > 0) {
          ...
          this.$http({
            url: this.$http.adornUrl('/generator/webimages/en/save'),
            method: 'post',
            data: goodsObj
          }).then(({data}) => {
            this.$message({
      ...
      getPictureList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/webimages/en/getIntroPictureList'),
          method: 'get'
        }).then(({data}) => {
          console.log(data)
          if (data && data.code === 0) {
