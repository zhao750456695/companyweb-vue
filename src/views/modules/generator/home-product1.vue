...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getData () {
        this.$http({
          url: this.$http.adornUrl('/generator/homeproducts/list-all'),
          method: 'get'
        }).then(({data}) => {
      ...
      getProductList () {
        this.$http({
          url: this.$http.adornUrl('/generator/goods/list-all'),
          method: 'get'
        }).then(({data}) => {
      ...
      dataFormSubmit (index) {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/homeproducts/save'),
          method: 'post',
          data: dataObj
        }).then(({data}) => {
          this.$message({
